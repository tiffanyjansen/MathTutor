    ...
    public class ClassLevelExcel
    {
        ...
        public byte[] GenerateExcel(List<ProfData> data)
        {
            using (var excelPackage = new ExcelPackage())
            {
                ...
                excelPackage.Workbook.Properties.Title = "Science Center Data by Class Level";
                var sheet = excelPackage.Workbook.Worksheets.Add("ByClass");
                sheet.Name = "Science Center Report by Class Level";
                //Class Info
                sheet.Column(1).Width = 10; //DeptPrefix
                sheet.Column(2).Width = 10; //ClassNum
                sheet.Column(3).Width = 12; //CRN
                sheet.Column(4).Width = 15; //Instructor
