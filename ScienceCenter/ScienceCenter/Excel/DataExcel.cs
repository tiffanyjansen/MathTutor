    ...
    public class DataExcel
    {
        ...
        public byte[] GenerateExcel(List<Data> data)
        {
            using (var excelPackage = new ExcelPackage())
            {
                ...
                sheet.Column(3).Width = 6; //Hour
                sheet.Column(4).Width = 7; //Min
                //Student Info
                sheet.Column(5).Width = 15; //FirstName
                sheet.Column(6).Width = 15; //LastName
                //Class Info
                sheet.Column(7).Width = 7; //CRN
                sheet.Column(8).Width = 12; //DeptPrefix
                sheet.Column(9).Width = 12; //ClassNum
                sheet.Column(10).Width = 25; //Instructor
                sheet.Column(11).Width = 6; //Days
                sheet.Column(12).Width = 10; //StartTime
